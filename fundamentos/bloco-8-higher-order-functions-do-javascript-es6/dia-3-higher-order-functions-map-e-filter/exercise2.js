...
// Cada objeto deve conter uma propriedade author , com o nome da pessoa autora
// do livro, e uma propriedade age com a idade dessa pessoa quando o livro foi lançado.
...
const exercicioDois = books.map((livro) => {
  const objeto = {
...
exercicioDois.sort((a, b) => a.age - b.age);

console.log(exercicioDois);